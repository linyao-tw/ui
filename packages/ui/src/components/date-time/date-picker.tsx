...
import { DatePicker as AriaDatePicker, type DatePickerProps as AriaDatePickerProps, type DateValue } from "react-aria-components/DatePicker";
...
export interface DatePickerProps<T extends DateValue = CalendarDate>
	extends Omit<AriaDatePickerProps<T>, "children" | "className" | "isDisabled" | "isInvalid" | "isOpen" | "isReadOnly" | "isRequired" | "onChange">, DatePickerChromeProps {
	onValueChange?: AriaDatePickerProps<T>["onChange"];
}
...
function SingleDatePicker<T extends DateValue>(
	{
		label,
		description,
		errorMessage,
...
function DatePickerImpl<T extends DateValue>(props: DatePickerProps<T>, ref: React.ForwardedRef<HTMLDivElement>) {
...
export const DatePicker = forwardRef(DatePickerImpl) as <T extends DateValue = CalendarDate>(props: DatePickerProps<T> & RefAttributes<HTMLDivElement>) => ReactElement | null;
